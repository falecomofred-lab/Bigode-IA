...
/* O crachá é por endereço — o deste computador não vale no de outra
   máquina e vice-versa. O `token` solto continua sendo lido para quem já
   estava logado antes desta mudança. */
...
async function entrar() {
  ...
  // Guarda o crachá NO ENDEREÇO em que o login aconteceu. Assim o login
  // deste computador e o de outra máquina convivem, e alternar entre eles
  // não pede senha de novo.
  {
